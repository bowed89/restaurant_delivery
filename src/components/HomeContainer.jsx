        ...
        <section className='grid grid-cols-1 md:grid-cols-2 gap-2 w-full' id='home'>
            ...
            <div className='py-2 flex-1 flex flex-col items-start 
                ...
                <p className='text-base text-textColor text-center md:text-left md:w-[80%]'>Lorem ipsum dolor sit amet consectetur adipisicing elit.
                    Eligendi ratione voluptatibus sed similique harum et ab culpa
                    qui quam numquam! Facere assumenda natus culpa accusantium recusandae
                    perferendis quia nobis magni!
                </p>
            ...
            <div className='py-2 flex-1 flex items-center relative'>
                <img
                    src={HeroBg}
                    className='ml-auto h-420 lg:w-auto w-full lg:h-650'
                    alt="herp-bg" />
