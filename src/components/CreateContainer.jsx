...
const CreateContainer = () => {
  ...
  const uploadImage = (e) => {
    ...
    uploadTask.on('state_changed', (snapshot) => {
      ...
      console.log(error);
      setFields(true)
      setMsg('Error while app is uploading: Try again.')
  ...
  const saveDetails = () => {
    ...
    try {
      ...
      if ([title, calories, imageAsset, price, category].includes('')) {
        setFields(true)
  ...
  // Get datas foodItems from context provider that we loaded in app.js
